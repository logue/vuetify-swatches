...
#### [3.0.0](https://github.com/logue/vuetify-swatches/compare/2.0.0...3.0.0)

> 28 November 2025

**Breaking Changes:**

- **Component Architecture**: Migrated from `v-sheet` to `v-item-group` for better semantic radio button behavior
- **Component Extraction**: Button logic extracted to separate `SwatchButton.vue` component
- **Default Swatches**: Default `swatches` prop is now an empty array. Users must provide their own color palettes or import presets
- **Preset Palettes**: Color presets are no longer bundled with the main component. Import them separately:
  - Basic palette (22 colors): `import { basicPalette } from 'vuetify-swatches/presets/basic'`
  - Advanced palette (~200 colors): `import { advancedPalette } from 'vuetify-swatches/presets/advanced'`

**New Features:**

- Added `inline` prop to display swatches in a single row
- Added preset color palettes as separate imports (tree-shakeable)
- Comprehensive test suite with 47 passing tests

**Improvements:**

- Bundle size reduced by ~47% (11.65 KB → 6.13 KB for ES module)
- Main component is now palette-agnostic, allowing maximum flexibility
- Better TypeScript support with proper readonly types
- Improved component structure and maintainability

#### [2.0.0](https://github.com/logue/vuetify-swatches/compare/1.8.0...2.0.0)

> 28 November 2025

- Initial separation of preset palettes from main bundle
